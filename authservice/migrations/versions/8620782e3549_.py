...
def downgrade():
    ...
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False, comment='Дата обновления'),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='login_history_user_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', 'logged_in_at', name='login_history_p2023_03_pkey'),
    sa.UniqueConstraint('user_id', 'logged_in_at', name='login_history_p2023_03_user_id_logged_in_at_key')
    )
    ...
    sa.UniqueConstraint('user_id', 'logged_in_at', name='login_history_p2023_01_user_id_logged_in_at_key')
    )
    ...
    sa.UniqueConstraint('user_id', 'logged_in_at', name='login_history_p2022_12_user_id_logged_in_at_key')
    )
    ...
    sa.UniqueConstraint('user_id', 'logged_in_at', name='login_history_default_user_id_logged_in_at_key')
    )
    ...
    sa.UniqueConstraint('user_id', 'logged_in_at', name='login_history_p2022_09_user_id_logged_in_at_key')
    )
    ...
    sa.UniqueConstraint('user_id', 'logged_in_at', name='login_history_p2022_08_user_id_logged_in_at_key')
    )
    ...
    sa.UniqueConstraint('user_id', 'logged_in_at', name='login_history_p2022_07_user_id_logged_in_at_key')
    )
    ...
    sa.UniqueConstraint('user_id', 'logged_in_at', name='login_history_p2022_10_user_id_logged_in_at_key')
    )
    ...
    sa.UniqueConstraint('user_id', 'logged_in_at', name='login_history_p2022_11_user_id_logged_in_at_key')
    )
    ...
    sa.UniqueConstraint('user_id', 'logged_in_at', name='login_history_p2023_02_user_id_logged_in_at_key')
    )
